...
instance Print (Grammar.Abs.Prog' a) where
  prt i = \case
    Grammar.Abs.Program _ topdefvars topdefs blok -> prPrec i 0 (concatD [prt 0 topdefvars, prt 0 topdefs, doc (showString "Main"), doc (showString "{"), prt 0 blok, doc (showString "}")])

instance Print (Grammar.Abs.TopDefVar' a) where
  prt i = \case
    Grammar.Abs.VarDef _ type_ id_ -> prPrec i 0 (concatD [doc (showString "create"), doc (showString "("), prt 0 type_, prt 0 id_, doc (showString ")"), doc (showString ";")])
...
instance Print (Grammar.Abs.TopDef' a) where
  prt i = \case
    Grammar.Abs.FnDef _ type_ id_ args blok -> prPrec i 0 (concatD [doc (showString "declare"), prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "{"), prt 0 blok, doc (showString "}")])
...
instance Print (Grammar.Abs.Arg' a) where
  prt i = \case
    Grammar.Abs.Argcopy _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_])
...
instance Print (Grammar.Abs.Blok' a) where
  prt i = \case
    Grammar.Abs.Block _ stmts -> prPrec i 0 (concatD [prt 0 stmts])
...
instance Print (Grammar.Abs.Stmt' a) where
  prt i = \case
    ...
    Grammar.Abs.Decl _ topdefvar -> prPrec i 0 (concatD [prt 0 topdefvar])
    Grammar.Abs.DeclFun _ topdef -> prPrec i 0 (concatD [prt 0 topdef])
    Grammar.Abs.Ass _ type_ id_ expr -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])
    Grammar.Abs.Incr _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "++"), doc (showString ";")])
    Grammar.Abs.Decr _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "--"), doc (showString ";")])
    Grammar.Abs.Ret _ expr -> prPrec i 0 (concatD [doc (showString "return"), prt 0 expr, doc (showString ";")])
    Grammar.Abs.Retv _ -> prPrec i 0 (concatD [doc (showString "return"), doc (showString ";")])
    ...
    Grammar.Abs.WhileSuspended _ expr stmts -> prPrec i 0 (concatD [doc (showString "while"), prt 0 expr, doc (showString "then"), prt 0 stmts, doc (showString "endwhile")])
    Grammar.Abs.WhileContinued _ expr stmts -> prPrec i 0 (concatD [doc (showString "while"), prt 0 expr, doc (showString "then"), prt 0 stmts, doc (showString "endwhile")])
...
instance Print (Grammar.Abs.Type' a) where
  prt i = \case
    Grammar.Abs.Int _ -> prPrec i 0 (concatD [doc (showString "$")])
    Grammar.Abs.Str _ -> prPrec i 0 (concatD [doc (showString "#")])
    Grammar.Abs.Bool _ -> prPrec i 0 (concatD [doc (showString "'")])
    Grammar.Abs.Void _ -> prPrec i 0 (concatD [doc (showString "@")])
...
instance Print (Grammar.Abs.Expr' a) where
  prt i = \case
    Grammar.Abs.EVar _ type_ id_ -> prPrec i 6 (concatD [prt 0 type_, prt 0 id_])
    ...
    Grammar.Abs.EApp _ type_ id_ exprs -> prPrec i 6 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
