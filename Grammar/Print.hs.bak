...
instance Print (Grammar.Abs.TopDef' a) where
  prt i = \case
    Grammar.Abs.FnDef _ type_ id_ args blok -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "{"), prt 0 blok, doc (showString "}")])
...
instance Print (Grammar.Abs.Stmt' a) where
  prt i = \case
    ...
    Grammar.Abs.Decl _ type_ id_ -> prPrec i 0 (concatD [doc (showString "create"), doc (showString "("), prt 0 type_, prt 0 id_, doc (showString ")"), doc (showString ";")])
